...
let currentCharacters = []; // Armazena os personagens da página atual
...
async function loadMainContent(page) {
  ...
  currentCharacters = [...characters]; // Armazena para filtro
...
// 🔍 Filtro de busca por nome (funciona por página)
